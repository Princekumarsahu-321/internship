...
import { USER_ACCOMODATION_STORAGE_KEY } from "../../data/staticData";
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      try {
        ...
        const savedAccomodations = JSON.parse(
          window.localStorage.getItem(USER_ACCOMODATION_STORAGE_KEY) || "[]"
        );
        window.localStorage.setItem(
          USER_ACCOMODATION_STORAGE_KEY,
          JSON.stringify([...savedAccomodations, newAccomodation])
        );
